...
export default Service.extend({
  stringComparators: null,
  numberComparators: null,
  dateComparators: null,
  booleanComparators: null,
  dropdownComparators: null,

  init() {
    this._super(...arguments);

    this.set('stringComparators', this.createComparators([
    ...
    this.set('numberComparators', this.createComparators([
    ...
    this.set('dateComparators', this.createComparators([
    ...
    this.set('booleanComparators', this.createComparators([
    ...
    this.set('dropdownComparators', this.createComparators([
