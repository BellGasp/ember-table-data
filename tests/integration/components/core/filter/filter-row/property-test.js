...
moduleForComponent('core/filter/filter-row/property',
  'Integration | Component | core/filter/filter row/property', {
    integration: true
  }
);
...
test('it renders the comparators when provided', function(assert) {
  ...
  assert.equal(this.$('.property-selector').text().trim(), 'test1',
